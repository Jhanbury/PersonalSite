...
namespace Site.Persistance.Migrations
{
    ...
    [Migration("20190407105856_added-githubReposId")]
    partial class addedgithubReposId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Site.Application.Entities.ContactInformation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Site.Application.Entities.PersonalProject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Site.Application.Entities.PersonalProjectTechnology", b =>
                {
            ...
            modelBuilder.Entity("Site.Application.Entities.PersonalProjectTechnology", b =>
                {
                    b.HasOne("Site.Application.Entities.PersonalProject", "PersonalProject")
            ...
            modelBuilder.Entity("Site.Application.Entities.User", b =>
                {
                    b.HasOne("Site.Application.Entities.ContactInformation", "ContactInformation")
                        .WithOne("User")
                        .HasForeignKey("Site.Application.Entities.User", "Id")
                        .OnDelete(DeleteBehavior.Cascade);
                });
