...
namespace Scheduler
{
  public class JobScheduler
  {
    ...
    public async Task DailyJobs([TimerTrigger("0 0 0 * * *")] TimerInfo myTimer, ILogger log)
    {
    ...
    [FunctionName("WeeklyJobs")]
    public async Task WeeklyJobs([TimerTrigger("0 0 0 * * 0")] TimerInfo myTimer, ILogger log)
    {
