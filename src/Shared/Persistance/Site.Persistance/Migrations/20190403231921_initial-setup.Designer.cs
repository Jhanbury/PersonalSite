...
namespace Site.Persistance.Migrations
{
    ...
    [Migration("20190403231921_initial-setup")]
            ...
            modelBuilder.Entity("Site.Domains.Entities.User", b =>
                {
                    ...
                    b.Property<int?>("ContactInformationId1");
                    ...
                    b.HasIndex("ContactInformationId1");
            ...
            modelBuilder.Entity("Site.Domains.Entities.User", b =>
                {
                    b.HasOne("Site.Domains.Entities.ContactInformation", "ContactInformation")
                        .WithMany()
                        .HasForeignKey("ContactInformationId1");

                    b.HasOne("Site.Domains.Entities.ContactInformation")
                        .WithOne("User")
